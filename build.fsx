...
let project = "ImmutableHashCollections"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "immutable hash collections benchmarks"
...
let author = "krauthaufen"

// Tags for your project (for NuGet package)
let tags = "hashmap immutable persistent"

// File system information
let solutionFile  = "ImmutableHashCollections.sln"
...
let gitOwner = "krauthaufen"
let gitHome = sprintf "%s/%s" "https://github.com/krauthaufen/ImmutableHashCollections" gitOwner

// The name of the project on GitHub
let gitName = "ImmutableHashCollections"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/krauthaufen"

let website = "/ImmutableHashCollections"
...
let info =
  [ "project-name", "ImmutableHashCollections"
    "project-author", "krauthaufen"
    "project-summary", "immutable hash collections benchmarks"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ImmutableHashCollections" ]
