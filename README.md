...
The test currently updates a single (already existing) entry (`N/2`) in a (Hash)Map of size `N`.   
...
Seems to improve things, but  the implementation of course gets uglier...
